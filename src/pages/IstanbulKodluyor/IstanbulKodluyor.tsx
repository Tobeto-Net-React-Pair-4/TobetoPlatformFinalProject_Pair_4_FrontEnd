	...
	return (
		<Container fluid>
			<Row className="bg-darkblue">
				<img
					className="ik-logo"
					src="../../../public/assets/images/istkodluyorlogo.svg"
					alt="İstanbul Kodluyor"
				/>
				<div className="col-12 d-flex flex-column justify-content-center px-10 text-center">
					<span className="header-text-md mt-5 mb-5 ">
						Ücretsiz eğitimlerle, geleceğin mesleklerinde sen de yerini al.
					</span>
					<span className="header-text mt-8 mb-5">
			...
			<Row>
				<Col className="col-6 bg-lightblue d-flex justify-content-center">
					<p className="text-center ic-header">
						Yazılım ve teknoloji alanında yeni bir kariyere adım atmak
						istiyorsan
					</p>
					...
					<div className="mt-20 connect-us">
						<div className="sss">
							<div className="d-flex justify-content-center align-items-center ">
								...
								<span className="sss-text">
									Sıkça Sorulan Sorulara Bakabilirsin
								</span>
							</div>
							<div>
								<a
									className="btn btn-primary ms-10 my-sm-4 button-width"
			...
			<Row className="education">
				<EducationButton imgSrc="../../../public/assets/images/web_egitim_ikonlar_yazilim-web.4aba227e.svg" />
				<EducationButton imgSrc="../../../public/assets/images/web_egitim_ikonlar_siber-guvenlik.0eb95dc9.svg" />
				<EducationButton imgSrc="../../../public/assets/images/web_egitim_ikonlar_veri-bilimi.b917503a.svg" />
				<EducationButton imgSrc="../../../public/assets/images/web_egitim_ikonlar_bulut-yazilim.5697ec17.svg" />
				<EducationButton imgSrc="../../../public/assets/images/web_egitim_ikonlar_mobil-uygulama.f3b8032f.svg" />
				<EducationButton imgSrc="../../../public/assets/images/web_egitim_ikonlar_uiux.d98f05d7.svg" />
				<EducationButton imgSrc="../../../public/assets/images/web_egitim_ikonlar_dijital-pazarlama.6527675a.svg" />
				<EducationButton imgSrc="../../../public/assets/images/web_egitim_ikonlar_ag-guvenlik.6bf38107.svg" />
				<EducationButton imgSrc="../../../public/assets/images/web_egitim_ikonlar_sistem.a6f8bc42.svg" />
				<EducationButton imgSrc="../../../public/assets/images/web_egitim_ikonlar_oyun.8722b2b4.svg" />
			</Row>
			<Row className="bg-lightgreen">
				<div className="header-left-2">
				...
				<div className="col-12 text-center p-10 ">
					<div className=" partners mt-10 partners-column ">
						<div>
							<span className="partners-firstrow">
								<img
									className="tcsan-bak"
									alt="Sanayi ve Teknoloji Bakanlığır Logo"
									src="../../../public/assets/images/stb.png"
								/>
							</span>
						</div>
						<div>
							<span className="partners-firstrow">
								<img
									className="ika"
									alt=""
									src="../../../public/assets/images/istka.png"
								/>
							</span>
							<span className="partners-firstrow">
								<img
									...
									src="../../../public/assets/images/boi.png"
								/>
							</span>
						</div>
						<div>
							<span className="partners-firstrow">
								<img
									className="etki"
									alt=""
									src="../../../public/assets/images/etki.png"
								/>
							</span>
						</div>
					</div>
					<div className="partners mt-20">
						<span>
							<span>
								<img
									className="enocta enocta-mb"
									alt=""
									src="../../../public/assets/images/enocta logo.svg"
								/>
							</span>
							<img
								className="enocta"
								alt=""
								src="../../../public/assets/images/tobeto-logo.png"
							/>
						</span>
					</div>
				</div>
			...
			<Row className="container-fluid">
				...
				<div className="row web-pack-green d-flex justify-content-center">
					<div className="col-12 p-2">
						{faqs.map((item) => (
							<Faqs header={item.name} text={item.value} />
						))}
					</div>
				</div>
			</Row>
				...
				<div className="col-12 d-flex justify-content-center pt-10">
					<span className="footer-logo">
						<img
							...
							src="../../../public/assets/images/istkodluyorlogo.svg"
							alt="istanbul kodluyor logo"
						/>
					</span>
				</div>
				<div className="col-12 my-10 col-lg-auto text-center icon-sec">
					<a
						className="text-decoration-none me-4 icon"
